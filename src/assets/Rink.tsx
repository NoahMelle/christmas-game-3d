...
export default function Rink({
    ...
    const colliderThickness = 2;
    const cornerLength = 3;
    const wallDiagonal = Math.sqrt(cornerLength ** 2 + colliderThickness ** 2);
    ...
    const cornerDistances = {
        x: size.x / 2 + borderThickness - wallDiagonal / 2,
        z: size.z / 2 + borderThickness - wallDiagonal / 2,
    };
